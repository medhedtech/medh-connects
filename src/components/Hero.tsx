...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-gradient-to-r from-gray-900 to-transparent">
      <div className="h-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative z-10 flex flex-col justify-center items-start px-6 md:px-10 py-12">
          <div className="animate-fade-in max-w-xl">
            ...
            <p className="text-lg md:text-xl text-white mb-8 font-serif drop-shadow-md bg-black/30 backdrop-blur-sm p-4 rounded-lg text-left">
      ...
      <button 
        ...
        className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-white hover:text-accent-green transition-colors z-20"

      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 md:px-8">
        <div className="animate-fade-in max-w-4xl">
          <div className="flex justify-center">
            <span className="bg-white/10 backdrop-blur-sm text-white px-4 py-1 rounded-full text-sm font-medium border border-white/20 mb-6">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 font-sans leading-tight">
            ...
            <span className="text-accent-green">Empowering Mothers</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto font-serif">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/get-involved"
              className="inline-flex items-center gap-2 text-white bg-white/20 backdrop-blur-sm hover:bg-white/30 font-medium text-lg py-3 px-8 rounded-full transition-all hover:shadow-lg border border-white/30"
            >
              <span>Volunteer</span>
            </a>
          </div>
        ...
        <button 
          ...
          className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-white hover:text-primary-green transition-colors"
